...
class _Scanner extends State<CameraView> {
  ...
  Widget build(BuildContext context) {
    ...
    const ButtonStyle bStyle = ButtonStyle(
      iconColor:
          WidgetStatePropertyAll<Color>(Color.fromARGB(255, 26, 152, 255)),
      backgroundColor:
          WidgetStatePropertyAll<Color>(Color.fromARGB(255, 41, 41, 41)),
    );
